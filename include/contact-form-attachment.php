...
if( $_SERVER['REQUEST_METHOD'] == 'POST') {
 ...
 if($email != '') {
                ...
                $mail->Host = 'smtp.google.com';                  // Specify main and backup SMTP servers, example: smtp1.example.com;smtp2.example.com
                $mail->SMTPAuth = true;                               // Enable SMTP authentication
                $mail->Username = 'joneschris903';                    // SMTP username
                $mail->Password = 'Plasticfire454!';                    // SMTP password
